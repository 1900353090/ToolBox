...
public class SnowflakeIdWorker {
     ...
     */
    protected SnowflakeIdWorker(long workerId) {
...
//下方的原代码，全部注释，只保留中间的一行，解决跨毫秒全为偶数问题
//        //如果是同一时间生成的，则进行毫秒内序列
...
//        }
    ...
    private class ClockMovedBackwardsException extends RuntimeException {

        private ClockMovedBackwardsException(String msg) {
            super(msg);
        }
